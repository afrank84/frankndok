...
| ---------------------------------- | --------------------------------------- | -------------------------------------------------- |
| Warning against repetition         | Matthew 6:7                             | Do not use vain, repeated phrases in prayer        |
| Prayer should be reverent          | Ecclesiastes 5:2                        | Let words be few and thoughtful before God         |
| Model prayer is simple and sincere | Matthew 6:9–13                          | Jesus gave a pattern, not a formula for repetition |
| Biblical examples of prayer        | 1 Samuel 1:10–15; Psalms; Luke 22:41–44 | Sincere, heartfelt communication with God          |
